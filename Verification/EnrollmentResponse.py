class EnrollmentResponse(object):
    ...
    def __init__(self, response):
        ...
        remaining_enrollments = self._REMAINING_ENROLLMENTS
        self._remaining_enrollments = response.get(remaining_enrollments, None)
    ...
    def get_remaining_enrollments(self):
        """
        Returns the number of remaining enrollments
        before the profile is ready for verification
        """

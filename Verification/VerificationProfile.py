class VerificationProfile(object):
    ...
    def __init__(self, response):
        ...
        self._remaining_enrollments_count = response.get(
            self._REMAINING_ENROLLMENTS_COUNT, None
        )
        self._created_date_time = response.get(self._CREATED_DATE_TIME, None)
        last_action_date_time = self._LAST_ACTION_DATE_TIME
        self._last_action_date_time = response.get(last_action_date_time, None)
    ...
    def get_enrollments_count(self):
        ...
        speech samples submitted for enrollment for this user
        """
    ...
    def get_remaining_enrollments_count(self):
        ...
        speech samples required remaining to complete enrollment
        """
